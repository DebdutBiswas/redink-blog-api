...
ARG MAIL_SENDER_ADDRESS=dummyblogalerts@localhost
ENV MAIL_SENDER_ADDRESS $MAIL_SENDER_ADDRESS

ARG MAIL_SENDER_NAME="Dummy Blog Alerts"
ENV MAIL_SENDER_NAME $MAIL_SENDER_NAME

ARG MAIL_USER=dummyblogalerts@localhost
ENV MAIL_USER $MAIL_USER

ARG MAIL_PASS=abc@123_mail
ENV MAIL_PASS $MAIL_PASS

ARG MAIL_SECURE=0
ENV MAIL_SECURE $MAIL_SECURE

ARG MAIL_START_TLS=0
ENV MAIL_START_TLS $MAIL_START_TLS

ARG MAIL_STRICT_TLS=0
ENV MAIL_STRICT_TLS $MAIL_STRICT_TLS
